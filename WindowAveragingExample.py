...
def active_power_calc (data_path, col_name="5V power uW", window=1000000000, csv_delimiter=","):
    ...
    if (window_samples == 2):
        ...
        if (value2 > worst_case):
            worst_case = value2
    # Otherwise push the samples onto the window queue
    else:
    ...
    while (data_line is not None):        
        ...
        window_average = sum(window_sample_data) / len(window_sample_data)
